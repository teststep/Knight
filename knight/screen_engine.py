            ...
            for i in range(len(self.game_engine.map[0]) - min_x):
                for j in range(len(self.game_engine.map) - min_y):
                    self.blit(self.game_engine.map[min_y + j][min_x + i][
                                  0], (i * self.game_engine.sprite_size,
...
class ProgressBar(ScreenHandle):
    ...
    def draw(self, canvas):
        ...
        self.blit(
            font.render('Hero at {}'.format(self.engine.hero.position), True, colors["black"]),
            (250, 0))

        self.blit(font.render('{} floor'.format(self.engine.level), True, colors["black"]),
                  (10, 0))
        ...
        self.blit(font.render('{}'.format(self.engine.hero.hp/self.engine.hero.max_h), True,
                              colors["black"]),
                  (60, 30))
        self.blit(
            font.render('{}'.format(self.engine.hero.exp/(100*(2**(self.engine.hero.level-1)))),
                        True, colors["black"]),
            (60, 70))
        ...
        self.blit(font.render('{}'.format(self.engine.hero.level), True, colors["black"]),
                  (360, 30))
        self.blit(font.render('{}'.format(self.engine.hero.gold), True, colors["black"]),
                  (360, 70))
        ...
        self.blit(
            font.render('{}'.format(self.engine.hero.stats["strength"]), True, colors["black"]),
            (480, 30))
        self.blit(font.render('{}'.format(self.engine.hero.stats["luck"]), True, colors["black"]),
                  (480, 70))

        self.blit(font.render('SCORE', True, colors["black"]),
                  (550, 30))
        self.blit(font.render('{:.4f}'.format(self.engine.score), True, colors["black"]),
                  (550, 70))
